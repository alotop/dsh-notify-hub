// @alotop/dsh-notify-hub — browser half (client plugin bundle).
//
// Loaded by dsh-client-modules at /plugins/??@alotop/dsh-notify-hub/client.js and
...
//
// The registration id MUST equal package.json's name: the client module system
// keys factories by package row, and scripts/check-client.mjs enforces the match.
window.__ModuleLoader__.load({
	id: "@alotop/dsh-notify-hub",
	factory: (require) => {
		var module = { exports: {} };
