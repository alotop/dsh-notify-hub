...
/**
 * Reduce Markdown to plain text for SMS-like transports (移动新消息 renders
 * Markdown markers literally). Ported from the reference cmcc-newmsg channel.
...
export function markdownToPlainText(markdown) {
  ...
  let text = markdown
  // Drop the fence line together with its info string: “```ts” must not survive
  // as a stray “ts” line above the code on a phone.
